import { a as ue } from "./chunk-6XBD6J36.js";
import { b as de, c as ge } from "./chunk-WPCERQDE.js";
import { a as pe } from "./chunk-JUO7JZR4.js";
...
import { b as I } from "./chunk-P4VF4CN3.js";
  ...
  if (((l[6] = (l[6] & 15) | 64), (l[8] = (l[8] & 63) | 128), e)) {
    if (((o = o || 0), o < 0 || o + 16 > e.length))
      throw new RangeError(
        `UUID byte range ${o}:${o + 15} is out of buffer bounds`,
      );
    for (let i = 0; i < 16; ++i) e[o + i] = l[i];
    return e;
  }
  return fe(l);
}
...
var Q = (() => {
  var t = h((L, s, n, a) => {
    ...
    H = {
      ...
      performAction: h(function (s, n, a, c, p, r, B) {
        var u = r.length - 1;
        switch (p) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            c.getLogger().info("Node: ", r[u].id),
              c.addNode(r[u - 1].length, r[u].id, r[u].descr, r[u].type);
            break;
          case 16:
          ...
          case 18:
            ...
            break;
          case 19:
            c.getLogger().trace("Node: ", r[u].id),
              c.addNode(0, r[u].id, r[u].descr, r[u].type);
            break;
          case 20:
            c.decorateNode({ icon: r[u] });
            break;
          case 25:
            c.getLogger().trace("node found ..", r[u - 2]),
              (this.$ = {
                id: r[u - 1],
                descr: r[u - 1],
                type: c.getType(r[u - 2], r[u]),
              });
            break;
          case 26:
            ...
            break;
          case 27:
            c.getLogger().trace("node found ..", r[u - 3]),
              (this.$ = {
                id: r[u - 3],
                descr: r[u - 1],
                type: c.getType(r[u - 2], r[u]),
      ...
      parse: h(function (s) {
        var n = this,
          ...
          ye = 2,
          ne = 1,
          ke = r.slice.call(arguments, 1),
          m = Object.create(this.lexer),
          T = { yy: {} };
        for (var W in this.yy)
          Object.hasOwn(this.yy, W) && (T.yy[W] = this.yy[W]);
        m.setInput(s, T.yy),
          (T.yy.lexer = m),
          (T.yy.parser = this),
        ...
        function re() {
          ...
          return (
            (S = c.pop() || m.lex() || ne),
            typeof S != "number" &&
              (S instanceof Array && ((c = S), (S = c.pop())),
              (S = n.symbols_[S] || S)),
            S
          );
        }
        ...
        for (var E, z, O, x, Re, Y, C = {}, G, N, se, j; ; ) {
          if (
            ...
            this.defaultActions[O]
              ? (x = this.defaultActions[O])
              : ((E === null || typeof E > "u") && (E = re()),
                (x = B[O] && B[O][E])),
          ...
          switch (x[0]) {
            ...
            case 2:
              ...
              N &&
                ...
                p.push(C.$),
                r.push(C._$),
                (se = B[a[a.length - 2]][a[a.length - 1]]),
                a.push(se);
              break;
            case 3:
              return !0;
      ...
      var L = {
        ...
        unput: h(function (s) {
          ...
          return (
            ...
            this.options.ranges &&
              (this.yylloc.range = [p[0], p[0] + this.yyleng - n]),
...
` +
        ...
        next: h(function () {
          ...
          for (var p = this._currentRules(), r = 0; r < p.length; r++)
            if (
              ((a = this._input.match(this.rules[p[r]])),
              a && (!n || a[0].length > n[0].length))
            ) {
          ...
          return n
            ? ((s = this.test_match(n, p[c])), s === !1 ? !1 : s)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: h(function (n, a, c, p) {
          ...
          switch (c) {
            ...
            case 10:
              return (
                n.getLogger().trace("Exploding node"), this.begin("NODE"), 19
              );
              break;
            case 11:
            ...
            case 12:
              return (
                n.getLogger().trace("Explosion Bang"), this.begin("NODE"), 19
              );
              break;
            case 13:
            ...
            case 25:
              return (
                n.getLogger().trace("description:", a.yytext), "NODE_DESCR"
              );
              break;
            case 26:
              this.popState();
            ...
            case 29:
              return (
                this.popState(),
                n.getLogger().trace("node end ...", a.yytext),
                "NODE_DEND"
              );
              break;
            case 30:
    ...
    ((R = class {
      ...
      getParent(e) {
        for (let o = this.nodes.length - 1; o >= 0; o--)
          if (this.nodes[o].level < e) return this.nodes[o];
        return null;
      }
      getMindmap() {
      ...
      addNode(e, o, l, i) {
        ...
        let f = w(),
          y = f.mindmap?.padding ?? M.mindmap.padding;
        switch (i) {
      ...
      assignSections(e, o) {
        if (
          (e.level === 0 ? (e.section = void 0) : (e.section = o), e.children)
        )
          for (const [l, i] of e.children.entries()) {
            const d = e.level === 0 ? l % (De - 1) : o;
      ...
      flattenNodes(e, o) {
        ...
        e.isRoot === !0
          ...
          : e.section !== void 0 && i.push(`section-${e.section}`),
        ...
        if ((o.push(y), e.children))
          for (const k of e.children) this.flattenNodes(k, o);
      }
      generateEdges(e, o) {
      ...
      getData() {
        ...
        if ((i || (d.layout = "cose-bilkent"), !e))
          return { nodes: [], edges: [], config: d };
        I.debug("getData: mindmapRoot", e, o), this.assignSections(e);
        const f = [],
          y = [];
        this.flattenNodes(e, f),
          this.generateEdges(e, y),
          I.debug(`getData: processed ${f.length} nodes and ${y.length} edges`);
        const k = new Map();
        for (const _ of f)
          k.set(_.id, {
            shape: _.shape,
...
` + t,
    ...
    const i = l.db,
      d = i.getData(),
      f = ue(e, d.config.securityLevel);
    if (
      ((d.type = l.type),
      (d.layoutAlgorithm = ge(d.config.layout, { fallback: "cose-bilkent" })),
      (d.diagramId = e),
      !i.getMindmap())
    )
      return;
    d.nodes.forEach((g) => {
      g.shape === "rounded"
        ...
        : g.shape === "circle"
          ? (g.padding = 10)
          : g.shape === "rect"
            ? ((g.width = 0), (g.padding = 10))
            : g.shape === "hexagon" && ((g.width = 0), (g.height = 0));
    }),
      await de(d, f);
    const { themeVariables: k } = le(),
      { useGradient: _, gradientStart: v, gradientStop: A } = k;
    if (_ && v && A) {
      const g = f.attr("id"),
        $ = f
          .append("defs")
  ...
  Te = { draw: ve },
  Oe = h((t) => {
    let { theme: e, look: o } = t,
      l = "";
    for (let i = 0; i < t.THEME_COLOR_LIMIT; i++)
      (t["lineColor" + i] = t["lineColor" + i] || t["cScaleInv" + i]),
        oe(t["lineColor" + i])
          ? (t["lineColor" + i] = ae(t["lineColor" + i], 20))
          : (t["lineColor" + i] = ce(t["lineColor" + i], 20));
    for (let i = 0; i < t.THEME_COLOR_LIMIT; i++) {
      const d = "" + (o === "neo" ? Math.max(10 - (i - 1) * 2, 2) : 17 - 3 * i);
      l += `
  ...
  Ce = h((t) => {
    const { theme: e } = t,
      o = t.svgId,
      l = t.dropShadow
        ? t.dropShadow.replace("url(#drop-shadow)", `url(${o}-drop-shadow)`)
        : "none";
    return `
  .edge {
    stroke-width: 3;
