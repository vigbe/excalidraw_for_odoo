import { a as pe } from "./chunk-PQ52O3BH.js";
import { a as me, b as ke } from "./chunk-SGQVVFSA.js";
import { a as Ee } from "./chunk-QP3MATMC.js";
import { a as ye } from "./chunk-OKRCTAJQ.js";
import { b as fe, e as be } from "./chunk-U5RM33SR.js";
...
import { b as Y } from "./chunk-P4VF4CN3.js";
...
var ie = (() => {
  var e = o((O, i, n, s) => {
    ...
    U = [1, 31],
    N = [6, 7, 11, 24],
    j = [1, 6, 13, 16, 17, 20, 23],
    f = [1, 35],
    A = [1, 36],
    L = [1, 6, 7, 11, 13, 16, 17, 20, 23],
    H = [1, 38],
    T = {
      trace: o(() => {}, "trace"),
      yy: {},
      ...
      performAction: o(function (i, n, s, a, h, t, R) {
        var c = t.length - 1;
        switch (h) {
          case 6:
          case 7:
      ...
      parse: o(function (i) {
        var n = this,
          ...
          Se = 2,
          le = 1,
          Ne = t.slice.call(arguments, 1),
          y = Object.create(this.lexer),
          P = { yy: {} };
        for (var q in this.yy)
          Object.hasOwn(this.yy, q) && (P.yy[q] = this.yy[q]);
        y.setInput(i, P.yy),
          (P.yy.lexer = y),
          (P.yy.parser = this),
        ...
        for (var _, Z, V, x, We, $, G = {}, X, C, ue, K; ; ) {
          if (
            ...
            this.defaultActions[V]
              ? (x = this.defaultActions[V])
              : ((_ === null || typeof _ > "u") && (_ = he()),
                (x = R[V] && R[V][_])),
          ...
          switch (x[0]) {
            ...
            case 2:
              ...
              C &&
                ...
                (h = h.slice(0, -1 * C)),
                (t = t.slice(0, -1 * C))),
                s.push(this.productions_[x[1]][0]),
                h.push(G.$),
                t.push(G._$),
                (ue = R[s[s.length - 2]][s[s.length - 1]]),
                s.push(ue);
              break;
            case 3:
              return !0;
        ...
        unput: o(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: s
                ? (s.length === a.length ? this.yylloc.first_column : 0) +
                  a[a.length - s.length].length -
                  s[0].length
...
` +
        ...
        test_match: o(function (i, n) {
          ...
          if (
            (this.options.backtrack_lexer &&
              ...
              this.options.ranges &&
                (h.yylloc.range = this.yylloc.range.slice(0))),
            (a = i[0].match(/(?:\r\n?|\n).*/g)),
        ...
        next: o(function () {
          ...
          for (var h = this._currentRules(), t = 0; t < h.length; t++)
            if (
              ((s = this._input.match(this.rules[h[t]])),
              s && (!n || s[0].length > n[0].length))
            ) {
              if (((n = s), (a = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(s, h[t])), i !== !1)) return i;
                if (this._backtrack) {
                  n = !1;
                } else return !1;
          ...
          return n
            ? ((i = this.test_match(n, h[a])), i === !1 ? !1 : i)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        topState: o(function (n) {
          return (
            (n = this.conditionStack.length - 1 - Math.abs(n || 0)),
            n >= 0 ? this.conditionStack[n] : "INITIAL"
          );
        }, "topState"),
        pushState: o(function (n) {
          this.begin(n);
        }, "pushState"),
        ...
        performAction: o(function (n, s, a, h) {
          var t = h;
          switch (a) {
            case 0:
            ...
            case 16:
              return (
                n.getLogger().trace("Exploding node"), this.begin("NODE"), 20
              );
              break;
            case 17:
            ...
            case 18:
              return (
                n.getLogger().trace("Explosion Bang"), this.begin("NODE"), 20
              );
              break;
            case 19:
            ...
            case 31:
              return (
                n.getLogger().trace("description:", s.yytext), "NODE_DESCR"
              );
              break;
            case 32:
              this.popState();
            ...
            case 33:
              return (
                this.popState(), n.getLogger().trace("node end ))"), "NODE_DEND"
              );
              break;
            case 34:
              return (
            ...
            case 35:
              return (
                this.popState(),
                n.getLogger().trace("node end ...", s.yytext),
                "NODE_DEND"
              );
              break;
            case 36:
...
var De = ie,
  ...
  Ce = o((e, u, p, r, d) => {
    let k = M(),
      m = k.mindmap?.padding ?? W.mindmap.padding;
    switch (r) {
      case b.ROUNDED_RECT:
      case b.RECT:
      case b.HEXAGON:
...
` +
      ...
      const g = ke(I, { schema: me });
      if (
        g.shape &&
        (g.shape !== g.shape.toLowerCase() || g.shape.includes("_"))
      )
        throw new Error(
          `No such shape: ${g.shape}. Shape names should be lowercase.`,
        );
      g?.shape && g.shape === "kanbanItem" && (l.shape = g?.shape),
        g?.label && (l.label = g?.label),
        g?.icon && (l.icon = g?.icon.toString()),
        g?.assigned && (l.assigned = g?.assigned.toString()),
        g?.ticket && (l.ticket = g?.ticket.toString()),
        g?.priority && (l.priority = g?.priority);
    }
    const D = Oe(e);
  ...
  Te = o((e) => {
    ...
    const u = M(),
      p = v[v.length - 1];
    e.icon && (p.icon = B(e.icon, u)),
      e.class && (p.cssClasses = B(e.class, u));
  }, "decorateNode"),
  Re = o((e) => {
    switch (e) {
      case b.DEFAULT:
...
` + e,
    ...
    m.htmlLabels = !1;
    const l = pe(u);
    for (const f of k.nodes) f.domId = `${u}-${f.id}`;
    const D = l.append("g");
    D.attr("class", "sections");
    const I = l.append("g");
    I.attr("class", "items");
    let g = k.nodes.filter((f) => f.isGroup),
      w = 0,
      E = 10,
      U = [],
      N = 25;
    for (const f of g) {
      ...
      (w = w + 1),
        ...
        (f.rx = 5),
        (f.ry = 5),
        (f.cssClasses = f.cssClasses + " section-" + w);
    ...
    for (const f of g) {
      const A = U[j];
      j = j + 1;
      let L = m?.kanban?.sectionWidth || 200,
        H = (-L * 3) / 2 + N,
        T = H,
        J = k.nodes.filter((i) => i.parentId === f.id);
      for (const i of J) {
        if (i.isGroup)
          throw new Error(
        ...
        const s = (await fe(I, i, { config: m })).node().getBBox();
        (i.y = T + s.height / 2), await be(i), (T = i.y + s.height / 2 + E / 2);
      }
      const F = A.cluster.select("rect"),
        O = Math.max(T - H + 3 * E, 50) + (N - 25);
      F.attr("height", O);
    }
    de(
      void 0,
  ...
  Me = o((e) => {
    ...
    for (let r = 0; r < e.THEME_COLOR_LIMIT; r++)
      (e["lineColor" + r] = e["lineColor" + r] || e["cScaleInv" + r]),
        ge(e["lineColor" + r])
          ? (e["lineColor" + r] = te(e["lineColor" + r], 20))
          : (e["lineColor" + r] = ne(e["lineColor" + r], 20));
    const p = o((r, d) => (e.darkMode ? ne(r, d) : te(r, d)), "adjuster");
    for (let r = 0; r < e.THEME_COLOR_LIMIT; r++) {
      const d = "" + (17 - 3 * r);
      u += `
...
`,
  ...
  He = Ue,
  st = { db: je, renderer: Ge, parser: De, styles: He };
