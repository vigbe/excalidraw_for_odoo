import { a as it } from "./chunk-6XBD6J36.js";
import { b as tt, c as st } from "./chunk-WPCERQDE.js";
import { a as rt } from "./chunk-JUO7JZR4.js";
...
import { p as et } from "./chunk-DQ3JIKF2.js";
...
import { b as ye } from "./chunk-P4VF4CN3.js";
import { a as m, b as Ke } from "./chunk-YUSHYV7C.js";
...
var Ve = (() => {
  var e = m(($, i, a, o) => {
    ...
    Se = {
      ...
      performAction: m(function (i, a, o, s, d, t, de) {
        var l = t.length - 1;
        switch (d) {
          case 4:
          ...
          case 21:
            ...
            break;
          case 22:
            s.addRequirement(t[l - 5], t[l - 6]),
              s.setClass([t[l - 5]], t[l - 3]);
            break;
          case 23:
            s.setNewReqId(t[l - 2]);
            break;
      ...
      table: [
        { 3: 1, 4: 2, 6: r, 9: u, 11: h, 13: f },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: r, 9: u, 11: h, 13: f },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(n, [2, 6]),
        { 3: 12, 4: 2, 6: r, 9: u, 11: h, 13: f },
        { 1: [2, 2] },
        {
          4: 17,
          5: c,
        ...
        e(E, [2, 19]),
        e(E, [2, 20]),
        { 30: 60, 33: 62, 75: P, 89: b, 90: R },
        { 30: 63, 33: 62, 75: P, 89: b, 90: R },
        { 30: 64, 33: 62, 75: P, 89: b, 90: R },
        e(X, [2, 29]),
        e(X, [2, 30]),
        e(X, [2, 31]),
        e(X, [2, 32]),
        ...
        e(Ee, [2, 85]),
        e(Ee, [2, 86]),
        { 62: 69, 65: Le, 66: xe, 67: Oe, 68: we, 69: De, 70: Me, 71: Fe },
        { 62: 77, 65: Le, 66: xe, 67: Oe, 68: we, 69: De, 70: Me, 71: Fe },
        { 30: 78, 33: 62, 75: P, 89: b, 90: R },
        {
          73: 79,
          75: ee,
          76: U,
        ...
        { 30: 94, 33: 62, 75: P, 76: U, 89: b, 90: R },
        { 5: [1, 95] },
        { 30: 96, 33: 62, 75: P, 89: b, 90: R },
        { 5: [1, 97] },
        { 30: 98, 33: 62, 75: P, 89: b, 90: R },
        { 63: [1, 99] },
        e(Y, [2, 50]),
        e(Y, [2, 51]),
        e(Y, [2, 52]),
      ...
      parse: m(function (i) {
        var a = this,
          ...
          lt = 2,
          Be = 1,
          ct = t.slice.call(arguments, 1),
          k = Object.create(this.lexer),
          G = { yy: {} };
        for (var Ie in this.yy)
          Object.hasOwn(this.yy, Ie) && (G.yy[Ie] = this.yy[Ie]);
        k.setInput(i, G.yy),
          (G.yy.lexer = k),
          (G.yy.parser = this),
          typeof k.yylloc > "u" && (k.yylloc = {});
        var Te = k.yylloc;
        t.push(Te);
        ...
        function Qe() {
          ...
          return (
            (S = s.pop() || k.lex() || Be),
            typeof S != "number" &&
              (S instanceof Array && ((s = S), (S = s.pop())),
              (S = a.symbols_[S] || S)),
            S
          );
        }
            ...
            case 2:
              if (
                ...
                (qe = this.performAction.apply(
                  J,
                  [l, Ue, Re, G.yy, N[1], d, t].concat(ct),
                )),
                typeof qe < "u")
              )
                return qe;
              F &&
                ...
                (d = d.slice(0, -1 * F)),
                (t = t.slice(0, -1 * F))),
                o.push(this.productions_[N[1]][0]),
                d.push(J.$),
                t.push(J._$),
                (He = de[o[o.length - 2]][o[o.length - 1]]),
                o.push(He);
              break;
            case 3:
              return !0;
        ...
        unput: m(function (i) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: o
                ? (o.length === s.length ? this.yylloc.first_column : 0) +
                  s[s.length - o.length].length -
                  o[0].length
                : this.yylloc.first_column - a,
            }),
            this.options.ranges &&
              (this.yylloc.range = [d[0], d[0] + this.yyleng - a]),
...
` +
        ...
        next: m(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (
              ((o = this._input.match(this.rules[d[t]])),
              o && (!a || o[0].length > a[0].length))
            ) {
              if (((a = o), (s = t), this.options.backtrack_lexer)) {
                if (((i = this.test_match(o, d[t])), i !== !1)) return i;
                if (this._backtrack) {
                  a = !1;
                } else return !1;
          ...
          return a
            ? ((i = this.test_match(a, d[s])), i === !1 ? !1 : i)
            : this._input === ""
              ? this.EOF
              : this.parseError(
                  "Lexical error on line " +
...
` +
        ...
        performAction: m(function (a, o, s, d) {
          var t = d;
          switch (s) {
            case 0:
              return "title";
...
var ut = Ve,
    ...
    ((Z = class {
      constructor() {
        (this.relations = []),
          ...
          (this.getDiagramTitle = Ze),
          (this.getConfig = m(() => _e().requirement, "getConfig")),
          this.clear(),
      ...
      setNewReqId(r) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.requirementId = r);
      }
      setNewReqText(r) {
      ...
      setNewReqVerifyMethod(r) {
        this.latestRequirement !== void 0 &&
          (this.latestRequirement.verifyMethod = r);
      }
      addElement(r) {
        return (
          this.elements.has(r) ||
      ...
      setCssStyle(r, u) {
        for (const h of r) {
          const f = this.requirements.get(h) ?? this.elements.get(h);
          if (!u || !f) return;
          for (const n of u)
            n.includes(",")
              ? f.cssStyles.push(...n.split(","))
              : f.cssStyles.push(n);
        }
      }
      setClass(r, u) {
        for (const h of r) {
          ...
          if (f)
            for (const n of u) {
              f.classes.push(n);
              const c = this.classes.get(n)?.styles;
      ...
      defineClass(r, u) {
        for (const h of r) {
          ...
          f === void 0 &&
            ((f = { id: h, styles: [], textStyles: [] }),
            this.classes.set(h, f)),
            u &&
              u.forEach((n) => {
                if (/color/.exec(n)) {
                  const c = n.replace("fill", "bgFill");
                  f.textStyles.push(c);
                }
                f.styles.push(n);
              }),
            this.requirements.forEach((n) => {
              n.classes.includes(h) &&
                n.cssStyles.push(...u.flatMap((c) => c.split(",")));
            }),
      ...
      getData() {
        ...
        for (const n of this.requirements.values()) {
          const c = n;
          (c.id = n.name),
            (c.cssStyles = n.cssStyles),
            (c.cssClasses = n.classes.join(" ")),
            (c.shape = "requirementBox"),
            (c.look = r.look),
            (c.colorIndex = u.length),
            u.push(c);
        }
        ...
        for (const n of this.relations) {
          const c = n.type === this.Relationships.CONTAINS,
            p = {
              id: `${n.src}-${n.dst}-${f++}`,
              start:
                this.requirements.get(n.src)?.name ??
                this.elements.get(n.src)?.name,
              end:
                this.requirements.get(n.dst)?.name ??
                this.elements.get(n.dst)?.name,
              label: `&lt;&lt;${n.type}&gt;&gt;`,
  ...
  mt = m((e) => {
    const r = Ae(),
      ...
      { bkgColorArray: f, borderColorArray: n } = u;
    if (!n?.length) return "";
    let c = "";
  ...
  dt = m((e) => {
    const r = Ae(),
      ...
      { requirementEdgeLabelBackground: f } = h;
    return `
  ${mt(e)}
  marker {
...
`;
  ...
  nt = {};
Ke(nt, { draw: () => pt });
var pt = m(async (e, r, u, h) => {
    ye.info("REF0:"), ye.info("Drawing requirement diagram (unified)", r);
    const { securityLevel: f, state: n, layout: c, look: p } = _e(),
      g = h.db.getData(),
      _ = it(r, f);
    (g.type = h.type),
      (g.layoutAlgorithm = st(c)),
      (g.nodeSpacing = n?.nodeSpacing ?? 50),
      (g.rankSpacing = n?.rankSpacing ?? 50),
      (g.markers =
        p === "neo"
